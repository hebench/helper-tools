...
TEST_HARNESS="./reference-palisade-backend/build/third-party/frontend/frontend-build/test_harness/test_harness"
BACK_END="./reference-palisade-backend/build/libhebench_palisade_backend.so"
