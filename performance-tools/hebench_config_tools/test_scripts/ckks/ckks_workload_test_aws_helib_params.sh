...
export HEBENCH_COEFF_MOD_BITS=119
#export HEBENCH_SCALE_BITS=45
export HEBENCH_SAMPLE_SIZE_0=10
export HEBENCH_SAMPLE_SIZE_1=$(nproc)
#export HEBENCH_MULT_DEPTH=2

export HEBENCH_N=3456
$CONFIG_TOOL_DIR/configurable_env_workload_runner.sh $TEST_HARNESS $BACK_END $MODIFIED_CONFIG $OUTPUT_FOLDER 2,3 CKKS Latency,Offline

#export HEBENCH_COEFF_MOD_BITS=40
#export HEBENCH_SCALE_BITS=40
$CONFIG_TOOL_DIR/configurable_env_workload_runner.sh $TEST_HARNESS $BACK_END $MODIFIED_CONFIG $OUTPUT_FOLDER 4 CKKS Latency,Offline

export HEBENCH_N=242
export HEBENCH_COEFF_MOD_BITS=358
#export HEBENCH_SCALE_BITS=45
export HEBENCH_POLYMOD_DEGREE=16384
export HEBENCH_SAMPLE_SIZE_2=1152
#export HEBENCH_MULT_DEPTH=6
