...
export export HEBENCH_N=1000
export HEBENCH_POLYMOD_DEGREE=8192
export HEBENCH_COEFF_MOD_BITS=45
export HEBENCH_PLAIN_MOD_BITS=20
export HEBENCH_SCALE_BITS=45
export HEBENCH_SAMPLE_SIZE_0=100
export HEBENCH_SAMPLE_SIZE_1=100

export HEBENCH_MIN_TEST_TIME=100
$CONFIG_TOOL_DIR/configurable_env_workload_runner.sh $TEST_HARNESS $BACK_END $MODIFIED_CONFIG $OUTPUT_FOLDER 2,3 CKKS,BFV Latency,Offline

export HEBENCH_SAMPLE_SIZE_0=0
export HEBENCH_SAMPLE_SIZE_1=0

export HEBENCH_N=100
$CONFIG_TOOL_DIR/configurable_env_workload_runner.sh $TEST_HARNESS $BACK_END $MODIFIED_CONFIG $OUTPUT_FOLDER 4 CKKS,BFV Latency,Offline

export HEBENCH_ROWS_M0=10
export HEBENCH_COLS_M0=9
export HEBENCH_COLS_M1=8
$CONFIG_TOOL_DIR/configurable_env_workload_runner.sh $TEST_HARNESS $BACK_END $MODIFIED_CONFIG $OUTPUT_FOLDER 1 CKKS,BFV Latency,Offline

export HEBENCH_ROWS_M0=5
export HEBENCH_COLS_M0=4
export HEBENCH_COLS_M1=10
$CONFIG_TOOL_DIR/configurable_env_workload_runner.sh $TEST_HARNESS $BACK_END $MODIFIED_CONFIG $OUTPUT_FOLDER 1 CKKS,BFV Latency,Offline

export HEBENCH_N=16
export HEBENCH_POLYMOD_DEGREE=16384
$CONFIG_TOOL_DIR/configurable_env_workload_runner.sh $TEST_HARNESS $BACK_END $MODIFIED_CONFIG $OUTPUT_FOLDER 6 CKKS,BFV Latency,Offline
